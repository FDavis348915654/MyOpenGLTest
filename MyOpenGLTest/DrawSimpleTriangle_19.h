...
class DrawSimpleTriangle_19 : public SimpleDrawTestBase
{
public:
	...
	DrawSimpleTriangle_19(GLuint screenWidth, GLuint screenHeight) {
	...
	virtual void OnInitRender(GLFWwindow* window) {
		glfwSetWindowTitle(window, "DrawSimpleTriangle_19");
