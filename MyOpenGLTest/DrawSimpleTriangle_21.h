...
public:
	...
	virtual void OnInitRender(GLFWwindow* window) {
		...
		// 编译着色器
		shader[0] = Shader("../res/Shaders/lesson_06_depth_test.vs", "../res/Shaders/lesson_06_depth_test.fs"); // 木箱
		...
		shader[4] = Shader("../res/Shaders/lesson_10_cubemaps_1.vs", "../res/Shaders/lesson_10_cubemaps.fs"); // 天空盒 // 优化
		shader[5] = Shader("../res/Shaders/lesson_10_cubemaps_2.vs", "../res/Shaders/lesson_10_cubemaps_2.fs"); // 木箱 反射
		shader[6] = Shader("../res/Shaders/lesson_10_cubemaps_2.vs", "../res/Shaders/lesson_10_cubemaps_3.fs"); // 木箱 折射
		shader[7] = Shader("../res/Shaders/lesson_10_cubemaps_4.vs", "../res/Shaders/lesson_10_cubemaps_4.fs"); // 模型 反射贴图
		shader[8] = Shader("../res/Shaders/lesson_10_cubemaps_4.vs", "../res/Shaders/lesson_10_cubemaps_4_test.fs"); // 模型 反射贴图测试(只绘制了漫反射纹理)
		// 生成 VBO
		glGenBuffers(10, VBO);
		// 创建 EBO
		glGenBuffers(10, EBO);
	...
	virtual void OnRender() {
		...
		if (true) {
			//glDisable(GL_CULL_FACE);
			shader[8].use();
			shader[8].setVec3("cameraPos", camera->Position);
			...
			glActiveTexture(GL_TEXTURE3);
			glBindTexture(GL_TEXTURE_CUBE_MAP, cubeTexture);
			shader[8].setInt("skybox", 3);

			ourModel.Draw(shader[8]);
			//glEnable(GL_CULL_FACE);
		}
