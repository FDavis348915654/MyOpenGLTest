...
#pragma endregion
		...
		// 编译着色器
		shader[0] = Shader("../res/Shaders/lesson_14_antiAliasing.vs", "../res/Shaders/lesson_14_antiAliasing.frag");
		shader[1] = Shader("../res/Shaders/lesson_14_antiAliasing_framebuffers.vs", "../res/Shaders/lesson_14_antiAliasing_framebuffers.frag"); // 屏幕（帧缓冲）
